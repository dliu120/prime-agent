...
- Added an opt-in `bun` tool for persistent TypeScript cells, typed host requests, rich output, interruption, and best-effort V8 state persistence while retaining IPython as the default.
